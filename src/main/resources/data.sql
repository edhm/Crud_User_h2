...
CREATE TABLE tbl_user01(id INTEGER(11) PRIMARY KEY auto_increment, firstName VARCHAR(100), lastName VARCHAR(100), sex VARCHAR(1),  dni INTEGER(11), email VARCHAR(100))


CREATE TABLE tbl_user02(id INTEGER(11) PRIMARY KEY auto_increment, firstName VARCHAR(100), lastName VARCHAR(100), sex VARCHAR(1),  dni INTEGER(11), email VARCHAR(100))	